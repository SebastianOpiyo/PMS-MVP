...
## Quick start Guide
1. Assuming you have git installed, clone the project into your machine.
2. Find a quick start guide for the respective service in the base directory just in case you don't mind testing each in isolation.
